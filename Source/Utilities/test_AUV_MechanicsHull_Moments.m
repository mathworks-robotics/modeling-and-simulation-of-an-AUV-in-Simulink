% Code to run moments on the CoM tests and plot the simulation results for
% the AUV_MechanicsHullJointsNForces model
% Copyright 2020 The MathWorks, Inc.

% Store the name of the signal editor block
sigEditBlk = [gcs,'/Moments (N*m)'];
...
try
    figure(f1_AUV_MechanicsHull_Moments)
catch
    f1_AUV_MechanicsHull_Moments = ...
        figure('Name','f1_AUV_MechanicsHull_Moments');
end
...
legend_array = {'Pitch Moment ONLY',...
